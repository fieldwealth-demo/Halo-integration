...
const CF_BY_TYPE = [
{ icon: 'sparkles', iconChar: '+', color: 'rgb(84,121,240)', bg: 'rgba(84,121,240,0.14)', label: 'Contributions', sub: '423 transactions', delta: '+$78.4M', tone: 'success' },
...
{ label: 'Qualified Retirement', value: '$12.4M', amount: 12.4, color: 'rgb(84,121,240)' },
...
{ client: 'David Young', sub: 'IRA · Traditional', color: 'rgb(84,121,240)', type: 'Contribution', typeColor: 'rgb(84,121,240)', desc: 'Annual IRA Contribution', date: 'Nov 19, 2025', status: 'Completed', statusTone: 'success', amount: '+$7,000.00', amountTone: 'success' },
...
{ client: 'Susan Richardson', sub: 'Roth IRA', color: 'rgb(220,38,38)', type: 'Dividend', typeColor: 'rgb(84,121,240)', desc: 'Q4 Dividend Distribution', date: 'Nov 17, 2025', status: 'Completed', statusTone: 'success', amount: '+$3,245.67', amountTone: 'success' },
...
{ client: 'David Park', sub: 'Joint Account', color: 'rgb(234,179,8)', type: 'Contribution', typeColor: 'rgb(84,121,240)', desc: 'Monthly Systematic Investment', date: 'Nov 15, 2025', status: 'Completed', statusTone: 'success', amount: '+$5,000.00', amountTone: 'success' },
...
{ client: 'Michael Hughes', sub: 'SEP IRA', color: 'rgb(35,89,255)', type: 'Contribution', typeColor: 'rgb(84,121,240)', desc: 'SEP Employer Contribution', date: 'Nov 12, 2025', status: 'Completed', statusTone: 'success', amount: '+$66,000.00', amountTone: 'success' }];
...
function CFInflowsOutflows() {
  ...
  const opts = React.useMemo(() => ({
    ...
    series: [
    { name: 'Inflows',  data: CF_INFLOW,  color: 'rgba(84,121,240,0.45)',  borderColor: 'rgb(84,121,240)' },
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 14, marginTop: 6 }}>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontFamily: 'Inter', fontSize: 11, color: 'rgb(209,213,219)' }}>
              <span style={{ width: 8, height: 8, borderRadius: 9999, background: 'rgb(84,121,240)' }} /> Inflows
            </span>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontFamily: 'Inter', fontSize: 11, color: 'rgb(209,213,219)' }}>
    ...
    <div style={MP_CARD}>
      ...
      <div style={{ padding: '2px 18px 14px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div key={i} style={{ display: 'grid', gridTemplateColumns: '32px 1fr auto', alignItems: 'center', gap: 12 }}>
            ...
            color: r.tone === 'success' ? 'rgb(84,121,240)' : 'rgb(248,113,113)'
          }}>{r.delta}</div>
          </div>
        )}
      </div>
...
function CFNetTrend() {
  const opts = React.useMemo(() => ({
    ...
    plotOptions: { areaspline: {
        fillColor: { linearGradient: { x1: 0, x2: 0, y1: 0, y2: 1 }, stops: [[0, 'rgba(84,121,240,0.35)'], [1, 'rgba(84,121,240,0)']] },
        lineColor: 'rgb(84,121,240)', lineWidth: 2,
        marker: { enabled: true, radius: 3.5, fillColor: 'rgb(10,10,10)', lineColor: 'rgb(84,121,240)', lineWidth: 2, symbol: 'circle' }
      } },
      ...
      <div style={{ ...MP_HEAD, justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontFamily: 'Inter', fontSize: 11, color: 'rgb(209,213,219)', marginTop: 6 }}>
            <span style={{ width: 8, height: 8, borderRadius: 9999, background: 'rgb(84,121,240)' }} /> Net Cash Flow
          </div>
        </div>
        <button data-no-hint style={{
          ...
          return (
            <div key={i} style={{
              ...
              <span style={{
                ...
                color: r.amountTone === 'success' ? 'rgb(84,121,240)' : 'rgb(248,113,113)'
              }}>{r.amount}</span>
            </div>);
