    ...
    <Card style={{ gap: 8 }}>
      ...
      {delta && (
        <div style={{
          ...
          color: delta.startsWith('-') ? 'rgb(248,113,113)' : 'rgb(200,214,255)',
        }}>
...
function Badge({ children, variant = 'default' }) {
  const v = {
    ...
    success: { background:'rgba(35,89,255,0.18)', color:'rgb(200,214,255)', border: '1px solid rgba(35,89,255,0.35)' },
